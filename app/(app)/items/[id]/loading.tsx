...
export default function ItemDetailLoading() {
  return (
    <div className="mx-auto w-full max-w-3xl px-4 py-10">
      ...
      {/* Image block */}
      <div className="mb-6 h-72 animate-pulse rounded-2xl border border-zinc-800 bg-zinc-900" />
      ...
      <div className="mb-6 h-4 w-1/3 animate-pulse rounded bg-zinc-800" />

      {/* Description card */}
      <div className="mb-8 h-32 animate-pulse rounded-2xl border border-zinc-800 bg-zinc-900" />

      {/* Poster card */}
      <div className="mb-8 h-20 animate-pulse rounded-2xl border border-zinc-800 bg-zinc-900" />

      {/* Action bar */}
      <div className="h-11 w-full animate-pulse rounded-full bg-zinc-800" />
    </div>
  )
}
